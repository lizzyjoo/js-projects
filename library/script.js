...
confirmBtn.addEventListener("click", (event) => {
  ...
  // event delegation for the check and trash buttons 
  books.addEventListener("click", function(event) {
    if (event.target.closest(".check")) {
      const bookDiv = event.target.closest(".book_object");
      const index = bookDiv.getAttribute("arrIndex");
      markRead(myLibrary[index], event.target.closest(".check"));
    }
...
function displayBooks(arr) {
  // Iterate over the library array and create HTML elements for each book
      ...
      const bookInfo = `
          ...
          <div class="book-btns">
          <button class="book-btn check"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" ><path d="M12 2C6.5 2 2 6.5 2 12S6.5 22 12 22 22 17.5 22 12 17.5 2 12 2M12 20C7.59 20 4 16.41 4 12S7.59 4 12 4 20 7.59 20 12 16.41 20 12 20M16.59 7.58L10 14.17L7.41 11.59L6 13L10 17L18 9L16.59 7.58Z" /></svg></button>
          <button class="book-btn trash"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20A8,8 0 0,0 20,12A8,8 0 0,0 12,4M16,10V17A1,1 0 0,1 15,18H9A1,1 0 0,1 8,17V10H16M13.5,6L14.5,7H17V9H7V7H9.5L10.5,6H13.5Z" /></svg></button>
